  ...
  <nav class="navbar navbar-expand-lg bg-white sticky-top">
    ...
    <!-- Hero Section -->
     ...
     <header class="container pt-5">
      <h1 class="mb-5 fw-bolder text-uppercase text-center">Refresh your day with <br> a cup of milk </h1>
      ...
      <div class="container py-4">
        <div class="row">
          <div class="col-6 d-flex justify-content-center">
            <img height="600px" src="<?php echo base_url('resources/img/about-img.png');?>" alt="">
          </div>
    ...
    <section id="our-coffee">
      <div class="container py-5">
        ...
        <div class="row mb-5" style="--bs-gutter-x: 4rem">
          <div class="col-4">
            <div class="img-card">
              <img width="100%" src="<?php echo base_url('resources/img/coffee1.png'); ?>">
              <div class="hover">
          ...
          <div class="col-4">
            <div class="img-card">
              <img width="100%" src="<?php echo base_url('resources/img/coffee2.png'); ?>">
              <div class="hover">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 9H1M9 1V17V1Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
          ...
          <div class="col-4">
            <div class="img-card">
              <img width="100%" src="<?php echo base_url('resources/img/coffee3.png'); ?>">
              <div class="hover">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 9H1M9 1V17V1Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
     ...
     <section id="instagram" style="background-color:#F3F4F6;">
      <div class="container py-5">
        <div class="row mb-5" style="--bs-gutter-x: 2rem; --bs-gutter-y: 2rem">
          ...
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/ig1.png'); ?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/ig2.png'); ?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/ig3.png'); ?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/ig4.png'); ?>">
          </div>
          <div class="col-4">
            <img width="100%" src="<?php echo base_url('resources/img/ig5.png'); ?>">
          </div>
        </div>
      </div>
    </section>
